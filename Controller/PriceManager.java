...
public class PriceManager{
    ...
    public static void createPrice(){
        ...
        Price price=new Price(threeDSurcharge, blkBusterSurcharge, platinumSurcharge, goldSurcharge,
    ...
    public double calculateTicketPrice(Movie movie, Cinema cinema, AgeGroup ageGroup, Showtime showtime, Price price){
