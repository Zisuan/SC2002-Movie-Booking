...
public class Price implements Serializable {
    enum PriceType {
        THREE_D, BLOCK_BUSTER, PLATINUM, GOLD, SENIOR, STUDENT, ADULT, WEEKEND_PH
    }
    // additional price can be charged according to these factors alongside base
    // price based on age group
    ...
    // day of the week = [Weekday, Weekend/Public Holiday] weekdays(excl. public
    // holidays) have no surcharge
