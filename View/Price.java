...
public class Price {
    ...
    public static void PriceMenu() throws SecurityException, ClassNotFoundException, IOException {
        ...
        do {
            ...
            switch (sel1) {
                ...
                case 2:
                    ...
                    Price newPrice = new Price(threeDSurcharge, blkBusterSurcharge, platinumSurcharge, goldSurcharge,
                            seniorBasePrice, studentBasePrice, adultBasePrice);
